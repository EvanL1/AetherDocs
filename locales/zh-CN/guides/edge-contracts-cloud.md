...
使用 AetherEdge `v0.5.0`、AetherContracts `v0.1.0-alpha.3`，并选择读取同一份完整契约锁定文件的 AetherCloud 版本。请先在[版本兼容矩阵](https://docs.aetheriot.dev/compatibility/version-matrix/)中确认准确组合。
...
该示例不会配对或控制任何设备，也不需要消息代理或云服务。如需安装受治理的运行时，请参阅[入门任务](https://docs.aetheriot.dev/guides/getting-started/)。
