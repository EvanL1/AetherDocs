...
| 需求                                              | 首先阅读或运行                                                      |
| ------------------------------------------------- | ------------------------------------------------------------------- |
| 通用 JSON、整数、规范化与失败规则                 | [基础规范](/zh/aethercontracts/spec/foundation/)                       |
| Thing Model 结构和 P/M/A 迁移                     | [Thing Model v1 alpha](/zh/aethercontracts/spec/thing-model-v1alpha1/) |
| 委托提供方拓扑、类型化状态及其显式 CloudLink 扩展 | [Integration v1 alpha](/zh/aethercontracts/spec/integration-v1alpha1/) |
| CloudLink 消息与生命周期                          | [CloudLink v1 alpha](/zh/aethercontracts/spec/cloudlink-v1alpha1/)     |
| 发布分发与使用方锁                                | [分发规范 v1 alpha](/zh/aethercontracts/spec/distribution-v1alpha1/)   |
| 可执行一致性行为                                  | [TCK v1 alpha](/zh/aethercontracts/spec/tck-v1alpha1/)                 |
| 当前门槛与产品兼容性                              | [兼容性与发布门槛](/zh/aethercontracts/compatibility/)                 |
| 语言绑定和使用方证据                              | [一致性与使用方验证](/zh/aethercontracts/conformance/)                 |
...
- [TypeScript](/zh/aethercontracts/packages/typescript/)
- [Rust](/zh/aethercontracts/packages/rust/)
- [C99](/zh/aethercontracts/packages/c/)
- [C++17](/zh/aethercontracts/packages/cpp/)

四种绑定都执行公开测试夹具清单。它们是刻意收窄的基础能力，不是完整的生产传输编解码器。Go、Java 与 Python 绑定仍在规划中。

如果现有使用方仍引用边缘仓库的旧名称，请阅读[产品命名迁移](/zh/aethercontracts/migration/)。软件包和协议标识保持不变。
